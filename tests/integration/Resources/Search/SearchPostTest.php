...
class SearchPostTest extends IntegrationBaseTest
{
    ...
    public function testDoSearchGetDefaultTrue()
    {
        ...
        $jql = "";        
        $searchResource->doSearchPost($jql);
    ...
    public function testDoSearchGetStartAtTrue($secondIssueId)
    {
        ...
        $searchResource->doSearchPost($jql, $startAt);
        $result = $api->getRequestResult($searchResource);  
        $this->assertFalse($result->hasError());     
    ...
    public function testDoSearchGetMaxResultTrue()
    {
        ...
        $searchResource->doSearchPost($jql, $startAt, $maxResult);
        $result = $api->getRequestResult($searchResource);  
        $this->assertFalse($result->hasError());     
    ...
    public function testDoSearchGetValidateTrue()
    {
        ...
        $searchResource->doSearchPost($jql, $startAt, $maxResult, true);
        $result = $api->getRequestResult($searchResource);       
        $this->assertTrue($result->hasError());        
        
        $searchResource->doSearchPost($jql, $startAt, $maxResult, false);
        $result = $api->getRequestResult($searchResource);       
        $this->assertFalse($result->hasError());   
    }
    ...
    public function testDoSearchGetFieldsTrue()
    {
        ...
        $searchResource->doSearchPost($jql, $startAt, $maxResult, true, array("summary", "comment"));
        $result = $api->getRequestResult($searchResource);         
        $this->assertFalse($result->hasError());        
    ...
    public function testDoSearchGetExpandTrue()
    {
        ...
        $searchResource->doSearchPost($jql, $startAt, $maxResult, true, array(), array("names", "schema"));
        $result = $api->getRequestResult($searchResource);   
        $this->assertFalse($result->hasError());    
